...
import { type AccionDelRecorrido, ESTADO_INICIAL, type EstadoDelRecorrido, recorrido } from './recorrido.ts';
...
export function ProveedorDelRecorrido({ children, inicial = ESTADO_INICIAL }: ProveedorDelRecorridoProps) {
  const [estado, despachar] = useReducer(recorrido, inicial);
