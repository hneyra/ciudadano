...
import { lineColumnFromOffset, getObjectPropValue, isSimpleTemplateLiteral } from './ast-utils.js';
        ...
        const check = (expr, span) => {
            ...
            switch (inner.type) {
                ...
                case 'TemplateLiteral':
                    if (isSimpleTemplateLiteral(inner))
                        return;
                    break;
            ...
            const { span: s } = inner; // ponytail: JSXMemberExpression lacks span in the SWC union; real children always have one
            ...
            for (const child of children) {
                if (child.type === 'JSXExpressionContainer') {
                    if (child.expression.type !== 'JSXEmptyExpression')
                        check(child.expression, child.span);
                }
