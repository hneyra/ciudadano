...
class ExpressionResolver {
    ...
    captureVariableDeclarator(node) {
        try {
            ...
            if (idTypeAnnotation) {
                ...
                if (elementMembers)
                    this.arrayElementMembers.set(name, elementMembers);
            }
            // pattern 1:
     ...
     */
    resolveArrayElementMembers(tsType) {
        try {
            if (!tsType)
                return undefined;
     ...
     * (`items: IProps[]`).
     */
    setArrayElementMembers(name, members) {
        this.arrayElementMembers.set(name, members);
    }
    getArrayElementMembers(name) {
        return this.arrayElementMembers.get(name);
    }
    deleteArrayElementMembers(name) {
