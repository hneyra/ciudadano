/**
 * **Los tipos de `@kamayuk/verificaciones/prohibiciones`, hasta que los publique la libreria** (rentas#137).
 *
 ...
 * que rentas#137 dejo de copiar. Y que la forma siga siendo esta no depende de leer este archivo: lo
