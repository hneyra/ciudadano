 ...
 *
 * Portada de `rentas`; las cifras de abajo son de alli.
 *
 ...
 * arregla. El razonamiento entero y sus cifras estan en `rentas/docs/agent/HISTORY.md`, fila de rentas#138.
 *
 * <h2>La lista se DESCUBRE, no se escribe</h2>
 *
 * Se lee del arbol: toda hoja de `src/` —que es el codigo de produccion de este frontend— y de ella
...
/** Donde vive el codigo de produccion de este frontend. */
