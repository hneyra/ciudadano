 ...
 *
 * Medido en `rentas` quitando `"./estilos.css"` del `exports` de `@kamayuk/ui` —exactamente lo que `kamayuk-lib`#24 acaba de
 * hacer con `"./fuentes"`—:
 *
 ...
 *
 * Y funciona con el `link:`: medido en `rentas`, `resolve('@kamayuk/ui/estilos.css')` devuelve
